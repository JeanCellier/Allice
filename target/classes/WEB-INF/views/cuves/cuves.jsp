...
<main class="col-sm-9 col-md-10">
    ...
    <div class="row placeholders">
        ...
        <div class="col-sm-12 col-md-12" id="contentCuve" style="padding:30px;">
            <table id="tableCuve" class="table table-hover">
                <thead>
                <tr>
                    <td>Nom</td>
                    <td>Designation</td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title custom_align" id="Heading">Ajouter une nouvelle cuve</h4>
            </div>

            <div class="modal-body">
                <form id="addForm" action="./add" method="POST">
                    <div class="form-group">
                        <input class="form-control nom" name="nom" required type="text" placeholder="Nom de la cuve">
                    </div>
                    <div class="form-group">
                        <input class="form-control nom" name="designation" required type="text" placeholder="D&#233signation de la cuve">
                    </div>
                    <%--Comment ajouter des canister? btn + fenetre modale ou ajout de tous les champs?--%>
                    <%--<div class="form-group">--%>
                        <%--<input class="form-control nom" name="canister" type="text" placeholder="Creation des canisters">--%>
                    <%--</div>--%>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editForm" action="./edit" method="POST">
                    <div class="form-group">
                        <input class="form-control nom" id="nom" name="nom" required type="text" placeholder="Nom de la cuve">
                    </div>
