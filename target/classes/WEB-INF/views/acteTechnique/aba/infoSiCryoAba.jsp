		...
		<fieldset>
			...
			<table id="part1">
				...
				<tr>
					...
					<td><sf:input path="tableauDetailList[${vs.current}].jonc" type="text" size="10"/></td>

					<td><sf:input path="tableauDetailList[${vs.current}].numeroReceveuse" type="text" size="10"/></td>

					<td><sf:input path="tableauDetailList[${vs.current}].referenceTransfert" type="text" size="10"/></td>
