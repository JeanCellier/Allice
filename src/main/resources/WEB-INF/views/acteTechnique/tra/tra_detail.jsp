    ...
    <div class="modal-dialog modal-large">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title custom_align" id="HeadingOperateur">D&#233tails de la fiche</h4>
            </div>
            ...
            <div class="modal-body">
                ...
                <div class="row details">
                    <h4>Identification receveuse</h4>
                    <div class="col-sm-6">
                ...
                <div class="row details">
                    <h4>&Eacute;valuation du corps jaune</h4>
                    <div class="col-sm-4">
                ...
                <div class="row details">
                    <h4>Embryon(s) transf&eacute;r&eacute;(s)</h4>
                    <div class="col-sm-6">
            ...
            success: function (result) {
                if(result.succes == true) {
                    $('#details')
                        ...
                        .find('#date').text(' '+convertDate(result.objet.dateHeureMinute)).end()
