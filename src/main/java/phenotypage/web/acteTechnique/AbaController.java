...
public class AbaController
{
	...
	public String enteteAba(@PathVariable String nom, Model model)
	{
		...
		if (ficheAba.getHeader() != null)
		{
			model.addAttribute("header", ficheAba.getHeader());
		}
		else
		{
			Header header = headerService.newHeader();
	...
	public String enteteAba(@PathVariable String nom, @Valid Header header, Errors errors, Model model)
	{
		if (errors.hasErrors())
		{
			model.addAttribute("programmeList", programmeService.findAllProgramme());
		...
		if (ficheAba.getHeader() != null)
		{
			Header headerDeleted = ficheAba.getHeader();
			ficheAba.setHeader(null);
		...
		header.setFicheAba(ficheAba);
		ficheAba.setHeader(header);
