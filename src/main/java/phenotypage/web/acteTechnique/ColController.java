...
public class ColController
{
	...
	public String enteteCol(@PathVariable String nom, Model model)
	{
		...
		if (ficheCol.getHeader() == null)
		{
			model.addAttribute("header", headerService.newHeader());
		}
		else
		{
			model.addAttribute("header", ficheCol.getHeader());
		}
	...
	public String enteteCol(@PathVariable String nom, @Valid Header header, Errors errors, Model model)
	{
		if (errors.hasErrors())
		{
			model.addAttribute("programmeList", programmeService.findAllProgramme());
		...
		if (ficheCol.getHeader() != null)
		{
			Header headerDeleted = ficheCol.getHeader();
			ficheCol.setHeader(null);
		...
		header.setFicheCol(ficheCol);
		ficheCol.setHeader(header);
