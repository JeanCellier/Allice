...
//
////		if (ficheIa.getFiche() == null)
////		{
////			//model.addAttribute("fiche", headerService.newHeader());
////		}
////		else
////		{
////			model.addAttribute("fiche", ficheIa.getFiche());
////		}
//
...
//	public String enteteIa(@PathVariable String nom, @Valid Fiche fiche, Errors errors, Model model)
//	{
//		if (errors.hasErrors())
//		{
//			model.addAttribute("programmeList", programmeService.findAllProgramme());
...
////		if (ficheIa.getFiche() != null)
////		{
////			Fiche ficheDeleted = ficheIa.getFiche();
////			ficheIa.setFiche(null);
