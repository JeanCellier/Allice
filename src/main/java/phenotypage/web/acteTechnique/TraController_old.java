...
//public class TraController_old
//{
//	@Autowired
...
//
//		if (ficheTra.getFiche() != null)
//		{
//			model.addAttribute("fiche", ficheTra.getFiche());
//		}
//		else
//		{
...
//	public String enteteTra(@PathVariable String nom, @Valid Fiche fiche, Errors errors, Model model)
//	{
//		if (errors.hasErrors())
//		{
//			model.addAttribute("programmeList", programmeService.findAllProgramme());
...
//		if (ficheTra.getFiche() != null)
//		{
//			Fiche headerDeleted = ficheTra.getFiche();
//			ficheTra.setFiche(null);
...
//		}
//		fiche.setFicheTra(ficheTra);
//		ficheTra.setFiche(fiche);
